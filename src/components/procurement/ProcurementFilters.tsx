      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <DatePicker
              date={toDate(filters.startDate)}
              setDate={(d) => handleFilterChange('startDate', toStr(d) || undefined)}
          ...
          <div>
            ...
            <DatePicker
              date={toDate(filters.endDate)}
              setDate={(d) => handleFilterChange('endDate', toStr(d) || undefined)}
