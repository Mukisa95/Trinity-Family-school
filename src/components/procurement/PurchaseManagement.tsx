...
export function PurchaseManagement({
  ...
  // Auto-authenticate user with permissions when dialog opens
  useEffect(() => {
    if (isAddDialogOpen && user && hasPermissionToMakePurchase && !authenticatedUser) {
      // Auto-populate authenticated user for users with permission
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Academic Year and Term Selection - Now Editable */}
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          ...
                          // Update available terms when year changes
                          const selectedYear = academicYears.find(y => y.id === value);
                          if (selectedYear && selectedYear.terms.length > 0) {
                            setFormData(prev => ({
                              ...prev,
                              academicYearId: value,
                              termId: selectedYear.terms[0].id
                            }));
                          }
                        }}
                      >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          {(academicYears.find(y => y.id === formData.academicYearId)?.terms || availableTerms).map(term => (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <DatePicker
                  date={toDate(formData.purchaseDate)}
                  setDate={(d) => setFormData({ ...formData, purchaseDate: toStr(d) })}
