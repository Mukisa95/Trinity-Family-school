...
export function ItemManagement({ items, setItems, searchTerm, setSearchTerm, categoryFilter, statusFilter }: ItemManagementProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters removed - moved to global toolbar */}
