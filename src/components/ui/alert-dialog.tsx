...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-[99998] bg-slate-950/55 backdrop-blur-md backdrop-saturate-75 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
>(({ className, children, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-0 z-[99999] flex items-center justify-center overflow-y-auto bg-transparent p-3 outline-none sm:p-4 md:p-6",
