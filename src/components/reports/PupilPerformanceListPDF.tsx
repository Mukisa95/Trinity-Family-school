...
const PupilPerformanceListPDF: React.FC<PupilPerformanceListPDFProps> = ({
  ...
  // Count pupils by status (using appropriate term or global field)
  const statusCounts = pupils.reduce((acc: Record<string, number>, pupil) => {
    const status = (selectedTermId ? pupil.termPerformanceStatuses?.[selectedTermId] : pupil.performanceStatus) || pupil.performanceStatus || 'default';
          ...
          {pupils.map((pupil, index) => (
            ...
            >
              ...
              <View style={styles.colStatus}>
                <Text style={[
                  styles.statusText,
                  getStatusStyle((selectedTermId ? pupil.termPerformanceStatuses?.[selectedTermId] : pupil.performanceStatus) || pupil.performanceStatus)
                ]}>
                  {getStatusLabel((selectedTermId ? pupil.termPerformanceStatuses?.[selectedTermId] : pupil.performanceStatus) || pupil.performanceStatus, performanceOptions)}
                </Text>
              </View>
              <View style={styles.colId}>
