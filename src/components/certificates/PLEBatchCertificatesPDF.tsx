...
// Helper function to split school name intelligently
  ...
  return (
    <Document>
      {validPupils.map((pupil, index) => {
        ...
        // Split school name based on whether this pupil has a photo
              ...
              <View style={styles.content}>
                ...
                <View style={styles.studentInfo}>
                  ...
                  <View style={styles.identifierNumbers}>
                    ...
                    {pupil.additionalIdentifiers && pupil.additionalIdentifiers.length > 0 && pupil.additionalIdentifiers.map((identifier, index) => {
