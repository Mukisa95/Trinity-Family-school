      ...
      <View style={styles.reportsSection}>
        ...
        <View style={[styles.reportCard, styles.classTeacherCard]}>
          ...
          <Text style={styles.reportContent}>
            {commentPicker.classTeacher(pupilReport.pupilInfo.name, pupilReport.totalAggregates)}
          </Text>
        ...
        <View style={[styles.reportCard, styles.headTeacherCard]}>
          ...
          <Text style={styles.reportContent}>
            {commentPicker.headTeacher(pupilReport.pupilInfo.name, pupilReport.totalAggregates)}
          </Text>
          <View style={styles.signatureLine} />
        </View>
      </View>
...
export const ComprehensiveReportsPDF = ({ data }: { data: ComprehensiveReportsProps }) => {
  ...
  const commentPicker = useMemo(() => new AggregateCommentPicker(), []);
