...
const SinglePupilReportPage: React.FC<SinglePupilReportPageProps> = ({
  ...
  const formatPupilData = () => {
    ...
    const totalAggregatesNum = parseFloat(
      pupil.totalAggregates || pupil.total_aggregates || pupil.aggregates || pupil.total_points || 0
    );
    ...
    return {
      ...
      totalAggregates: totalAggregatesNum,
      ...
      classTeacherReport: commentPicker.classTeacher(pupil.name || 'Unknown', totalAggregatesNum),
      headTeacherReport: commentPicker.headTeacher(pupil.name || 'Unknown', totalAggregatesNum),
