...
import { formatTermName } from '@/lib/utils/term-formatter';
...
const styles = StyleSheet.create({
  ...
  topLeftCorner: {
    ...
    borderTopWidth: 4,
    borderLeftWidth: 4,
    borderTopColor: '#84994F',
    borderLeftColor: '#84994F',
  ...
  infoValue: {
    fontSize: 11,
    fontFamily: 'Helvetica-Bold',
    color: '#A72703', // Green color to make information stand out
  },
  ...
  pupilNameValue: {
    fontSize: 11,
    fontFamily: 'Helvetica-Bold',
    color: '#A72703', // Green color to make pupil name stand out
    flexWrap: 'wrap',
    lineHeight: 1.2,
  },
  redValue: {
...
export const TransPupilReportCardPDF: React.FC<PupilReportCardProps> = (props) => {
  const {
    pupilName,
    className,
    classCode,
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.contentContainer}>
        ...
        {/* Student Info - Always 2-line layout, use compact labels for long names */}
            ...
            <>
              <View style={styles.studentInfoRow}>
                ...
                <View style={[styles.infoItemCompact, { flex: 0.5 }]}>
                  ...
                  <Text style={styles.infoValue}>{age} yr</Text>
                </View>
          ...
          return (
            <View key={index} style={[dynamicStyles.tableRow, index % 2 === 1 ? styles.tableRowAlt : {}]}>
              <Text style={[dynamicStyles.tableCell, dynamicStyles.subjectCell, { 
                fontFamily: 'Helvetica-Bold',
                textTransform: 'uppercase',
                color: isMajor ? '#84994F' : '#6b7280' // Highlight major subjects
              }]}>
      ...
      <View style={[{
        ...
        <View style={{
          ...
          <View style={{
            backgroundColor: division === 'I' ? '#A72703' : 
                           division === 'II' ? '#FCB53B' : 
