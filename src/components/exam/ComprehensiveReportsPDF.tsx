...
export const generateComprehensiveReportsPDF = (props: ComprehensiveReportsProps) => {
  ...
  try {
    ...
    pupilReports.forEach((pupilReport, reportIndex) => {
      ...
      doc.setFontSize(9);
      doc.setFont('helvetica', 'normal');
      const classReport = commentPicker.classTeacher(pupilReport.pupilInfo.name, pupilReport.totalAggregates);
      ...
      doc.setFontSize(9);
      doc.setFont('helvetica', 'normal');
      const headReport = commentPicker.headTeacher(pupilReport.pupilInfo.name, pupilReport.totalAggregates);
