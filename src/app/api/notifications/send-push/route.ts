...
// Scheduled delivery is invoked from the due-job dispatcher and can include
// an inbox delivery plus multiple Web Push requests. Keep its limit aligned
// with the dispatcher so the outer job is not left leased by a 10-second cut-off.
