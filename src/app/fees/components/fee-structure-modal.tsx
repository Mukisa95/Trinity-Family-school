...
const FeeStructureModal: React.FC<FeeStructureModalProps> = ({
  ...
  const handleSubmit = () => {
    ...
    const validationFields = [
      ...
      createFieldValidation('amount', amount && parseFormattedMoney(typeof amount === 'string' ? amount : amount.toString()) > 0 ? amount : '', 'Amount', true),
        ...
        <div className="flex-grow min-h-0 overflow-y-auto">
          <div className="grid gap-4 p-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="feeAmount" type="text" value={typeof amount === 'string' ? amount : formatMoneyInput(amount.toString())} onChange={(e) => setAmount(formatMoneyInput(e.target.value))} />
            </div>
            <div className="space-y-2">
