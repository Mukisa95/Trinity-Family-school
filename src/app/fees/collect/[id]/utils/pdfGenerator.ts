      ...
      <div class="student-info">
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <span class="info-value">${pupil.payCode || pupil.additionalIdentifiers?.find(id => (id.idType || '').toLowerCase().includes('pay code'))?.idValue || 'N/A'}</span>
          </div>
          <div class="info-item">
      ...
      <div class="receipt-container">
        ...
        <div class="section-content">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
            ...
            <div class="info-row" style="grid-column: span 2;">Pay Code: <strong>${pupil.payCode || pupil.additionalIdentifiers?.find(id => (id.idType || '').toLowerCase().includes('pay code'))?.idValue || 'N/A'}</strong></div>
            </div>
          </div>
