...
export interface PupilFee extends FeeStructure {
  ...
  discount?: {
    ...
    reason?: string;
    category?: 'required' | 'non-required'; // For backward compatibility
    categories?: ('required' | 'non-required')[]; // New format - array of categories
    discountType?: 'full' | 'half' | 'quarter' | 'percentage';
  };
