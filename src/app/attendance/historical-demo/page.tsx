...
import { Calendar, Users, Camera, Database, CheckCircle, XCircle, Clock, Info, AlertCircle } from 'lucide-react';
...
export default function HistoricalAttendanceDemoPage() {
  ...
  const getAttendanceStats = () => {
    ...
    const delayed = attendanceRecords.filter(r => r.status === 'Delayed').length;

    return { present, absent, late, excused, delayed, total: attendanceRecords.length };
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <DatePicker
                ...
                setDate={(d) => setSelectedDate(d ? format(d, 'yyyy-MM-dd') : new Date().toISOString().split('T')[0])}
