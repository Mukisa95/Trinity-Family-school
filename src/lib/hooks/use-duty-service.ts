...
import type {
  ...
  CreateLeadershipTermData,
  UpdateLeadershipTermData
} from '@/types/duty-service';

// ===== LEADERSHIP TERMS HOOKS =====

export function useLeadershipTerms(academicYearId?: string) {
  return useQuery({
    queryKey: ['leadership-terms', academicYearId],
    queryFn: () => DutyServiceService.getLeadershipTerms(academicYearId),
  });
}

export function useCreateLeadershipTerm() {
  ...
  return useMutation({
    mutationFn: async (data: CreateLeadershipTermData) => {
      const termId = await DutyServiceService.createLeadershipTerm(data);

      await createSignature({
        recordType: 'leadership_term_creation',
        recordId: termId,
        action: 'create_leadership_term',
        description: `Created leadership term: ${data.termName}`,
        metadata: { termName: data.termName }
      });

      return termId;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['leadership-terms'] });
      toast({
        title: "Success",
        description: "Leadership term created successfully",
      });
    },
    onError: (error) => {
      ...
      toast({
        title: "Error",
        description: "Failed to create leadership term",
        variant: "destructive",
      });
    },
  });
...
export function useUpdateLeadershipTerm() {
  const queryClient = useQueryClient();
  const { toast } = useToast();
  const { createSignature } = useDigitalSignature();

  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: UpdateLeadershipTermData }) => {
      await DutyServiceService.updateLeadershipTerm(id, data);

      await createSignature({
        recordType: 'leadership_term_update',
        recordId: id,
        action: 'update_leadership_term',
        description: `Updated leadership term: ${data.termName || 'ID: ' + id}`,
        metadata: { termName: data.termName }
      });
    },
    onSuccess: (_, { id }) => {
      ...
      toast({
        title: "Success",
        description: "Leadership term updated successfully",
      });
    },
    onError: (error) => {
      console.error('Error updating leadership term:', error);
      toast({
        title: "Error",
        description: "Failed to update leadership term",
        variant: "destructive",
      });
    },
  });
...
export function useTerminateLeadershipTerm() {
  const queryClient = useQueryClient();
  const { toast } = useToast();
  const { createSignature } = useDigitalSignature();
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      await DutyServiceService.terminateLeadershipTerm(id);

      await createSignature({
        recordType: 'leadership_term_termination',
        recordId: id,
        action: 'terminate_leadership_term',
        description: `Terminated leadership term: ID ${id}`,
        metadata: { termId: id }
      });
    },
    onSuccess: () => {
      ...
      toast({
        title: "Success",
        description: "Leadership term terminated successfully",
      });
    },
    onError: (error) => {
      console.error('Error terminating leadership term:', error);
      toast({
        title: "Error",
        description: "Failed to terminate leadership term",
        variant: "destructive",
      });
    },
  });
...
export function usePrefectoralPosts() {
  return useQuery({
    queryKey: ['prefectoral-posts'],
    queryFn: () => DutyServiceService.getPrefectoralPosts(),
  });
}
...
export function useCreatePrefectoralPost() {
  ...
  return useMutation({
    mutationFn: async (data: CreatePrefectoralPostData) => {
      const postId = await DutyServiceService.createPrefectoralPost(data);
...
export function useAssignPupilToPost() {
  ...
  return useMutation({
    mutationFn: async (data: CreatePostAssignmentData) => {
      const assignmentId = await DutyServiceService.assignPupilToPost(data);
      ...
      await createSignature({
        ...
        metadata: { postId: data.postId, pupilId: data.pupilId, leadershipTermId: data.leadershipTermId }
      });
...
export function useCreateDutyRota() {
  ...
  return useMutation({
    mutationFn: async (data: CreateDutyRotaData) => {
      const rotaId = await DutyServiceService.createDutyRota(data);
...
export function useAssignMemberToDuty() {
  ...
  return useMutation({
    mutationFn: async (data: CreateDutyAssignmentData) => {
      const assignmentId = await DutyServiceService.assignMemberToDuty(data);
...
export function useCreatePoll() {
  ...
  return useMutation({
    mutationFn: async (data: CreatePollData) => {
      const pollId = await DutyServiceService.createPoll(data);
