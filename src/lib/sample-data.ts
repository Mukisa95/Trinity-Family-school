...
export const sampleClasses: Class[] = [
  {
    ...
    subjectAssignments: [
      { subjectId: "sub5", teacherId: "t2", teacherIds: ["t2"] }, 
    ],
  ...
  },
  {
    ...
    subjectAssignments: [
      { subjectId: "sub1", teacherId: "s1", teacherIds: ["s1"]},
      { subjectId: "sub2", teacherId: "t2", teacherIds: ["t2"]},
    ],
  ...
  },
  {
    ...
    subjectAssignments: [
      { subjectId: "sub2", teacherId: "t2", teacherIds: ["t2"] },
      { subjectId: "sub4", teacherId: undefined, teacherIds: [] },
      { subjectId: "sub5", teacherId: "t2", teacherIds: ["t2"] },
    ],
  ...
  },
  {
    ...
    subjectAssignments: [
      { subjectId: "sub1", teacherId: "s1", teacherIds: ["s1"] },
      { subjectId: "sub3", teacherId: "s1", teacherIds: ["s1"] },
    ],
...
export const sampleSchoolSettings: SchoolSettings = {
  ...
  socialMedia: { 
    ...
    whatsapp: "https://chat.whatsapp.com/LfKtwT6Qn5eDImR4gagwU3?mode=ac_t",
  },
};
