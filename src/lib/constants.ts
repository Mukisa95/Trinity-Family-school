...
export const PUPIL_STATUSES = ['Active', 'Inactive', 'Graduated', 'Transferred', 'Pending'] as const;
...
export const ATTENDANCE_STATUSES: AttendanceStatus[] = ['Present', 'Absent', 'Late', 'Excused', 'Delayed'];
